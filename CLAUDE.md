...
- **Backlog:** **54/54 prior features done.** Newly registered (not built): **FE-55 / FR-30 — admin-defined roles & permission-based RBAC** (EP-2, roadmap Sprint 12, ADR-0010 *Proposed*) — admins create/modify roles, `@RequirePermission` guards, admin Roles editor; user chose "register in spec only" for now. Remaining prior polish: FE-54 label migration of still-behavioral enums (billing period / role / cloud provider / checklist severity), code-coupled by design.
