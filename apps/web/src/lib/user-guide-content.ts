...
export const USER_GUIDE: GuideSection[] = [
  {
    ...
    title: 'Welcome',
    body: [
      'Kerdos turns scattered spreadsheets into consistent, auditable project cost estimates. You build an estimate from a governed rate card plus AWS/GCP/Azure cloud pricing, apply markup and contingency, see monthly and yearly costs, route it through an approval workflow, and export a professional summary.',
