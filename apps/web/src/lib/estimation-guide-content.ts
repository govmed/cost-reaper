...
export const ESTIMATION_GUIDE: GuideSection[] = [
  {
    ...
    body: [
      ...
      'cost-reaper is a bottom-up estimating tool: you build the number from line items (labor, non-labor, cloud, managed services, SaaS), apply contingency and markup, and record the assumptions behind it. This guide covers the estimating discipline; the User Guide covers the software.',
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      'Bottom-up — sum detailed line items by role, task, and resource. The most accurate and the most effort; this is cost-reaper’s core model.',
  ...
  },
  {
    id: 'glossary',
    title: 'Glossary',
    body: ['Common estimating terms used throughout cost-reaper:'],
    bullets: [
