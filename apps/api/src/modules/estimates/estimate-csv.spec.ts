  ...
  it('includes a header, the line, and the grand total; escapes commas', () => {
    const totals = computeEstimate(
      buildEngineInput({
        ...
        labor: [],
        nonLabor: [{ id: 'n1', category: 'Licenses', amount: '1000', periods: 1, billingPeriod: 'ONE_TIME', upchargePercentOverride: null }],
        cloud: [],
      }),
    );
    const csv = toCsv({ name: 'My, Estimate', currency: 'USD' }, [
      { type: 'Non-labor', description: 'Tooling', quantity: '1', unit: 'period', rate: '1000', billingPeriod: 'ONE_TIME', lineTotal: '1000.0000' },
    ], totals);
