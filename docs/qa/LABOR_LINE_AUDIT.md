...
**Scope:** the estimate **labor line item** feature (add-form, estimation engine, persistence, API, security) — triggered by a production defect report: _"I entered 8 units and none of the labors show 8 units."_
...
| **Reported**            | User: _"I entered 8 units and none of the Labors show 8 units… go look at the database."_                                                                                                                                                                                                                                                                                                                                                                                              |
