...
**SOW flavor · Implementation & Maintenance structured sections**

- FL-25 IMPL_MAINTENANCE is a valid flavor
- FL-26 a valid SLA tier parses
- FL-27 an SLA tier missing resolution is rejected
